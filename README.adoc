...
* Options : https://github.com/Dauphine-MIDO/M1-alternance/blob/master/Options/Sécurité%20et%20réseaux.adoc[Sécurité et réseaux], https://github.com/Dauphine-MIDO/M1-alternance/blob/master/Options/Décision%20collective,%20décision%20multicritère.adoc[Décision collective, décision multicritère]
