...
- Envoyer le https://github.com/Dauphine-MIDO/M1-app/blob/master/CFA-AFIA-_CR_de_suivi_en_entreprise.odt?raw=true[formulaire] (ou format https://github.com/Dauphine-MIDO/M1-app/blob/master/CFA-AFIA-_CR_de_suivi_en_entreprise.odt?raw=true[DOC]) complété suite à votre visite en entreprise à Patricia Lavagna
