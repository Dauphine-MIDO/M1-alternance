= Le mémoire de M1 MIAGE en alternance
:toc:
:toc-title: Sommaire
:lang: fr
...
=== Canevas LaTeX
Pour les étudiants qui souhaitent rédiger en utilisant LaTeX (ce qui est apprécié mais pas obligatoire), https://github.com/av1m/thesis-template[ce canevas] a été mis à disposition par un étudiant d’une année précédente. Merci à lui !
...
- délibération du jury (sans l’apprentie mais avec le maitre d’apprentissage) de 10 minutes
...
. Avant fin mars : Faire viser le plan détaillé du mémoire (env. 2 pages) par les deux encadrants
** Enregistrer le plan dans le livret

. Le 25 aout 2022 (_mise à jour_, cf. ci-dessous) au plus tard : Dépôt sur Moodle
...
** _Mise à jour du 24 aout_ : En raison d’un accès temporairement problématique à l’espace de remise des mémoires sur Moodle, la remise est décalée à la fin du dimanche 28 aout.

. Semaine du 5 septembre 2022 : soutenances
** En présentiel, à Dauphine (ou en hybride si le MA ne peut s’y rendre)
