...
Prévoir au minimum 3 exemplaires du mémoire : un pour le maitre d’apprentissage (remis par l’apprenti), deux remis au secrétariat (un pour le tuteur enseignant, un pour le CFA)
