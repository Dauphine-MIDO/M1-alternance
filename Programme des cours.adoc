...
Généré le 17 décembre 2023 à partir des données du https://dauphine.psl.eu/formations/masters/informatique/1re-annee-de-master-miage/programme[site internet] de Dauphine.
...
|ANDRE CHAMOULEAU; MEHDI MOATASSIM; ALAIN DEDENIS
|3
...
Enseignants responsables : ANDRE CHAMOULEAU; MEHDI MOATASSIM; ALAIN DEDENIS
